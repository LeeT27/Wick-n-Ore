...
function Navbar() {
  ...
  function toggleMenu() {
    if (toggle === 0) {
      document.getElementById("nav2").classList.add("pressed");
      toggle = 1;
    } else {
      document.getElementById("nav2").classList.remove("pressed");
      toggle = 0;
    }
  }
  let lastScrollTop = 0;
  ...
  return (
    <>
      <div id="darkOverlay" onClick={hideMenu}></div>
      <motion.div
